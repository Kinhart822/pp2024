...
with zipfile.ZipFile('pw6/students.dat', 'w') as archive:
    archive.write('pw6/students.pkl', 'students.pkl')
    archive.write('pw6/courses.pkl', 'courses.pkl')
    archive.write('pw6/marks.pkl', 'marks.pkl')

# Check if students.dat exists
if os.path.exists('pw6/students.dat'):
    with zipfile.ZipFile('pw6/students.dat', 'r') as archive:
        # Extract files from the archive
        archive.extract('students.pkl', 'pw6/')
        archive.extract('courses.pkl', 'pw6/')
        archive.extract('marks.pkl', 'pw6/')
